...
//                }
    ...
    public boolean init() {
        ...
        bleSeviceFilter.addAction(DeviceScanActivity.FIND_DEVICE_ALARM_ON);
        bleSeviceFilter.addAction(DeviceScanActivity.CANCEL_DEVICE_ALARM);
